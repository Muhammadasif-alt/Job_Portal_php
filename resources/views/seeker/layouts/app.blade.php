...
<head>
    ...
    <title>Job Seeker Panel | Jobs in USA</title><!--begin::Accessibility Meta Tags-->
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block">
                        <a href="{{ route('seeker.dashboard') }}" class="nav-link">
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <!-- My Applications -->
                        <li class="nav-item">
                            <a href="{{ route('seeker.applications') }}" class="nav-link {{ Request::routeIs('seeker.applications') ? 'active' : '' }}">
                        ...
                        <!-- My Profile -->
                        <li class="nav-item">
                            <a href="{{ route('seeker.profile') }}" class="nav-link {{ Request::routeIs('seeker.profile') ? 'active' : '' }}">
                        ...
                        <!-- Resume / CV -->
                        <li class="nav-item">
                            <a href="{{ route('seeker.resume') }}" class="nav-link {{ Request::routeIs('seeker.resume') ? 'active' : '' }}">
                        ...
                        <!-- Settings -->
                        <li class="nav-item">
                            <a href="{{ route('seeker.settings') }}" class="nav-link {{ Request::routeIs('seeker.settings') ? 'active' : '' }}">
