...
<head>
    ...
    <title>JobsListing | Jobs Management System</title><!--begin::Accessibility Meta Tags-->
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end user-dropdown">
                            ...
                            @if($authUser)
                                <li>
                                    <a class="dropdown-item" href="{{ route('admin.users.edit', $authUser) }}">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
                        ...
                        <li class="nav-item {{ Request::is('admin/jobs*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.jobs.create') }}" class="nav-link {{ Request::routeIs('admin.jobs.create') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Post New Job</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.jobs.import.form') }}" class="nav-link {{ Request::routeIs('admin.jobs.import.form') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Import Jobs</p>
                                    </a>
                                </li>
                        ...
                        <!-- Employer Management -->
                        <li class="nav-item {{ Request::is('admin/advertisers*') ? 'menu-open' : '' }}">
                            <a href="{{ route('admin.advertisers.index') }}" class="nav-link {{ Request::is('admin/advertisers*') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.advertisers.index') }}" class="nav-link {{ Request::routeIs('admin.advertisers.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>All Employers</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.advertisers.create') }}" class="nav-link {{ Request::routeIs('admin.advertisers.create') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Add Employer</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ Request::is('admin/blogs*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.blogcategories.index') }}" class="nav-link {{ Request::routeIs('admin.blogcategories.index') ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Blog Categories</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ Request::is('admin/contact-messages*') ? 'menu-open' : '' }}">
                            <a href="{{ route('admin.contact-messages.index') }}" class="nav-link {{ Request::is('admin/contact-messages*') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-envelope"></i>
                                <p>
                                    Contact Messages
                                    @if($newMsgCount > 0)
                                        <span class="badge bg-danger ms-2">{{ $newMsgCount }}</span>
                                    @endif
                                </p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item {{ Request::is('admin/users*') ? 'menu-open' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.users.index') }}" class="nav-link {{ Request::routeIs('admin.users.index') && empty($currentRole) ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>All Users</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.users.index', ['role' => 'job_seeker']) }}" class="nav-link {{ Request::routeIs('admin.users.index') && $currentRole === 'job_seeker' ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Job Seekers</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.users.index', ['role' => 'company']) }}" class="nav-link {{ Request::routeIs('admin.users.index') && $currentRole === 'company' ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Companies</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.users.index', ['role' => 'admin']) }}" class="nav-link {{ Request::routeIs('admin.users.index') && $currentRole === 'admin' ? 'active' : '' }}">
                                        <i class="nav-icon bi bi-circle"></i>
                                        <p>Administrators</p>
                                    </a>
                                </li>
